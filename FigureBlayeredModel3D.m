...
% New coeff Tra FD scheme
coeff=[1.25507	-0.126759	0.0390654	-0.0156734	0.00676	-0.002857	0.0011065	-0.000362	0.000087245	-0.0000113441];


for it=1:320,
    it
    %DeltaH/x
    DeltaHx=coeff(1)*(DeltaH-circshift(DeltaH,[1 0 0]))+...
        coeff(2)*(circshift(DeltaH,[-1 0 0])-circshift(DeltaH,[2 0 0]))+...
        coeff(3)*(circshift(DeltaH,[-2 0 0])-circshift(DeltaH,[3 0 0]))+...
        coeff(4)*(circshift(DeltaH,[-3 0 0])-circshift(DeltaH,[4 0 0]))+...
        coeff(5)*(circshift(DeltaH,[-4 0 0])-circshift(DeltaH,[5 0 0]))+...
        coeff(6)*(circshift(DeltaH,[-5 0 0])-circshift(DeltaH,[6 0 0]))+...
        coeff(7)*(circshift(DeltaH,[-6 0 0])-circshift(DeltaH,[7 0 0]))+...
        coeff(8)*(circshift(DeltaH,[-7 0 0])-circshift(DeltaH,[8 0 0]))+...
        coeff(9)*(circshift(DeltaH,[-8 0 0])-circshift(DeltaH,[9 0 0]))+...
        coeff(10)*(circshift(DeltaH,[-9 0 0])-circshift(DeltaH,[10 0 0]));

    
    %DeltaH/x
     DeltaHy=coeff(1)*(DeltaH-circshift(DeltaH,[0 1 0 ]))+...
        coeff(2)*(circshift(DeltaH,[0 -1 0 ])-circshift(DeltaH,[0 2 0 ]))+...
        coeff(3)*(circshift(DeltaH,[0 -2 0 ])-circshift(DeltaH,[0 3 0 ]))+...
        coeff(4)*(circshift(DeltaH,[0 -3 0 ])-circshift(DeltaH,[0 4 0 ]))+...
        coeff(5)*(circshift(DeltaH,[0 -4 0 ])-circshift(DeltaH,[0 5 0 ]))+...
        coeff(6)*(circshift(DeltaH,[0 -5 0 ])-circshift(DeltaH,[0 6 0 ]))+...
        coeff(7)*(circshift(DeltaH,[0 -6 0 ])-circshift(DeltaH,[0 7 0 ]))+...
        coeff(8)*(circshift(DeltaH,[0 -7 0 ])-circshift(DeltaH,[0 8 0 ]))+...
        coeff(9)*(circshift(DeltaH,[0 -8 0 ])-circshift(DeltaH,[0 9 0 ]))+...
        coeff(10)*(circshift(DeltaH,[0 -9 0 ])-circshift(DeltaH,[0 10 0 ]));
    
    %DeltaV/z
     DeltaVz=coeff(1)*(DeltaV-circshift(DeltaV,[0 0 1 ]))+...
        coeff(2)*(circshift(DeltaV,[0 0 -1 ])-circshift(DeltaV,[0 0 2 ]))+...
        coeff(3)*(circshift(DeltaV,[0 0 -2 ])-circshift(DeltaV,[0 0 3 ]))+...
        coeff(4)*(circshift(DeltaV,[0 0 -3 ])-circshift(DeltaV,[0 0 4 ]))+...
        coeff(5)*(circshift(DeltaV,[0 0 -4 ])-circshift(DeltaV,[0 0 5 ]))+...
        coeff(6)*(circshift(DeltaV,[0 0 -5 ])-circshift(DeltaV,[0 0 6 ]))+...
        coeff(7)*(circshift(DeltaV,[0 0 -6 ])-circshift(DeltaV,[0 0 7 ]))+...
        coeff(8)*(circshift(DeltaV,[0 0 -7 ])-circshift(DeltaV,[0 0 8 ]))+...
        coeff(9)*(circshift(DeltaV,[0 0 -8 ])-circshift(DeltaV,[0 0 9 ]))+...
        coeff(10)*(circshift(DeltaV,[0 0 -9 ])-circshift(DeltaV,[0 0 10 ]));
...
%     [Vx,Vz]=spongeABC(Vx,Vz,nx,nz,45,45,0.009);
    ...
    if rem(it,isnap)== 0,
        imagesc(x,z,squeeze(Vx(100,:,:)) ) , axis equal
        colormap gray
        xlabel('x'),ylabel('z')
...
toc
%
save('FigureBlayeredModel3DTraScheme110.mat')